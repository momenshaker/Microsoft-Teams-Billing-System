...
namespace BillingPortal.Infrasturcture.Services
{
    public class FetchData : IFetchData
    {
        ...
        public FetchData(ILogger<FetchData> logger,
        ...
        public  async void SaveCall(string id, string access_token)
        {
        ...
        public  CalculatedData CalculateCall(string Phone, TimeSpan TotalTime, DatabaseContext databaseContext)
        {
        ...
        public  async Task<string> GetCallInformationAsync(string token, string resource)
        {
            try
            {
