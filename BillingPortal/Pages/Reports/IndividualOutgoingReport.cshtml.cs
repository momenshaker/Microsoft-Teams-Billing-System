...
{
    public class IndividualOutgoingReportModel : PageModel
    {
        private readonly ILogger<IndividualOutgoingReportModel> _logger;
        private readonly DatabaseContext _context;

        public IndividualOutgoingReportModel(ILogger<IndividualOutgoingReportModel> logger, DatabaseContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public void OnGet(string id)
        {
            ...
            var GetAllRecords = _context.recordsTables.Where(x => x.CallerName == ConvertID).ToList();
